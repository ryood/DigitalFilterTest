...
extern float filter1_impulseInput[9];
extern float filter1_impulseOutput[9];
extern float filter1_noiseInput[31];
extern float filter1_noiseOutput[31];
extern float filter1_multiSineInput[18];
extern float filter1_multiSineOutput[18];
extern float filter1_overflowInput[9];
extern float filter1_overflowOutput[9];
extern float filter1_testOutput[31];
